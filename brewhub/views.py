...
def beer_styles():
    ...
    'london_brown_ale': london_brown_ale, 'piwo_grodziskie': piwo_grodziskie, 'pre_prohibition_lager': pre_prohibition_lager, 'pre_probition_porter':pre_probition_porter, 'roggenbier': roggenbier}
